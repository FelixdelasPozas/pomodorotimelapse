...
void Screenshot::shootScreen()
{
	...
	originalPixmap = QPixmap::grabWindow(QApplication::desktop()->winId(), QApplication::desktop()->x(), QApplication::desktop()->y(), QApplication::desktop()->width(), QApplication::desktop()->height());
	updateScreenshotLabel();
