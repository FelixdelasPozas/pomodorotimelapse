...
struct Configuration
{
  ...
  QColor timeOverlayTextColor = QColor(255,255,255); /** color of the text of the time overlay. */
  bool timeOverlayTextBorder = true;                 /** true to draw a border around the text in the time overlay, false otherwise. */
  bool timeOverlayBackground = true;                 /** true to draw the background in the time overlay. */
